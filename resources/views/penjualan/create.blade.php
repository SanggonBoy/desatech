    ...
    <div class="col-xxl-12">
        <div class="card stretch stretch-full">
            <div class="card-header">
                <h5 class="card-title">Tambah Transaksi Penjualan</h5>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="no_penjualan" class="form-control" value="{{ $noPenjualan }}"
                                    readonly required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <small class="text-info">
                                        <i class="feather-info"></i> Harga jual otomatis dihitung dengan profit 30% dari HPP
                                    </small>
                                </div>
                            </div>
                        </div>
...
@section('js')
    ...
    <script src="{{ asset('custom/js/penjualan-create.js') }}"></script>
@endsection
